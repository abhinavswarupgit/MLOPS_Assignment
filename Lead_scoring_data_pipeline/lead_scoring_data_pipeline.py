...
raw_data_schema_check = PythonOperator(task_id="checking_raw_data_schema",
                                      ...
                                      op_kwargs={'data_directory': data_directory, 'lead_scoring_file':lead_scoring_file, 'raw_data_schema': raw_data_schema},
                                      dag=ML_data_cleaning_dag)
...
load_data_into_db = PythonOperator(task_id='loading_data',
                                  ...
                                  op_kwargs={'db_path': db_path, 'db_file_name': db_file_name, 'data_directory': data_directory, 'lead_scoring_file': lead_scoring_file, 'table_name':table_name},
                                  dag=ML_data_cleaning_dag)
###############################################################################
