...
# here model_input_schema should have additional fields like :  'assistance_interaction', 'career_interaction', 'payment_interaction', 'social_interaction', 'syllabus_interaction', but leaving it as its pre filled in assignment.
